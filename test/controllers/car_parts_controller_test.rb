...
class CarPartsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create car_part" do
    assert_difference('CarPart.count') do
      post car_parts_url, params: { car_part: { car_id: @car_part.car_id, name: @car_part.name } }
    end
  ...
  test "should update car_part" do
    patch car_part_url(@car_part), params: { car_part: { car_id: @car_part.car_id, name: @car_part.name } }
