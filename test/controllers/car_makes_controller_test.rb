...
class CarMakesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create car_make" do
    assert_difference('CarMake.count') do
      post car_makes_url, params: { car_make: { country: @car_make.country, name: @car_make.name } }
    end
  ...
  test "should update car_make" do
    patch car_make_url(@car_make), params: { car_make: { country: @car_make.country, name: @car_make.name } }
